...
Kết quả kiểm chứng build/runtime gần nhất được ghi tại [`docs/baseline/S0-T01.md`](docs/baseline/S0-T01.md). Báo cáo phân biệt rõ kiểm tra đã PASS và các bước Windows/Tauri còn bị chặn; việc Vite chạy trên `localhost` không được tính là bằng chứng desktop runtime.
